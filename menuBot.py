...
m_DZ = Menu("ДЗ", buttons=["Задание-1", "Задание-2", "Задание-3", "Задание-4", "Задание-5", "Задание-6", "Задание-7", "Задание-8", "Задание-9", "Задание-10", "Выход"], parent=m_main, module="DZ")
m_fun = Menu("Развлечения", buttons=["Гороскоп", "Прислать кота", "Прислать собаку", "Прислать лису", "Прислать анекдот", "Прислать фильм", "Угадай кто?", "Выход"], parent=m_main, module="fun")
